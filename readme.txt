...
= 1.0.1 =
* Verified compatibility with WordPress 7.1 and updated "Tested up to".
* No functional changes: none of the WordPress 7.1 developer-facing changes
  affect this plugin. It adds no editor, media, toolbar or jQuery integration,
  and does not use @wordpress/components.
